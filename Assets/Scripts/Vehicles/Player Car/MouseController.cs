...
public class MouseController : MonoBehaviour
{
    ...
    public Vector2 LookAngle
    {
        get
        {
            ...
            {
                snapAngleX = mouseAimTransform.localEulerAngles.x;
                snapAngleY = mouseAimTransform.localEulerAngles.y;
            }
            if (Input.GetKeyUp(KeyCode.Mouse1))
            {
                mouseAimTransform.localEulerAngles = new Vector3(snapAngleX, snapAngleY, 0);
